...
<section id="berita" class="py-24 bg-gradient-to-br from-gray-100 to-white">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-16">
      <h2 class="text-2xl font-bold text-gray-900 mb-4">Berita & Pengumuman</h2>
            ...
            @forelse($beritaList as $berita)
              <article
                ...
                <div class="p-6">
                  ...
                  <h3 class="text-lg font-semibold text-gray-900 mb-2 line-clamp-2">{{ $berita->judul }}</h3>
            ...
            @forelse($pengumumanList as $pengumuman)
              <article
                ...
                <div class="p-6">
                  ...
                  <h3 class="text-lg font-semibold text-gray-900 mb-2 line-clamp-2">{{ $pengumuman->judul }}</h3>
