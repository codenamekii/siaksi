        ...
        <div
          ...
          <div class="flex items-start justify-between">
            <div>
              ...
              @if ($akreditasi->nilai_akreditasi)
                <div class="mt-4">
                  <p class="text-sm text-gray-500">Nilai Akreditasi</p>
                  <div class="flex items-center gap-2">
                    <span class="text-3xl font-bold text-gray-900">{{ $akreditasi->nilai_akreditasi }}</span>
