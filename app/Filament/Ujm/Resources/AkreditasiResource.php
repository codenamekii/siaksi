        ...
        return $form->schema([
            Forms\Components\Section::make('Informasi Akreditasi')
                ->schema([
                    ...
                    Forms\Components\Select::make('status_akreditasi')
                        ...
                        ->required()
                        ->reactive(),
                    Forms\Components\TextInput::make('nilai_akreditasi')->numeric()->maxValue(400)->minValue(0)->placeholder('Contoh: 361')->helperText('Nilai akreditasi (jika ada)')->suffix('/ 400'),
            ...
            Forms\Components\Section::make('Periode Akreditasi')
                ->schema([
                    ...
                    Forms\Components\TextInput::make('tahun_akreditasi')->disabled()->dehydrated(false)->default(fn(Get $get) => $get('tanggal_akreditasi') ? \Carbon\Carbon::parse($get('tanggal_akreditasi'))->year : null),
                ])
                ->columns(3),
            ...
            Forms\Components\Section::make('Dokumen Pendukung')->schema([
                Forms\Components\FileUpload::make('sertifikat')
                    ...
                    ->openable()
                    ->columnSpanFull(),
                Forms\Components\Textarea::make('catatan')->rows(3)->maxLength(500)->placeholder('Catatan tambahan (opsional)')->columnSpanFull(),
            ]),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('nilai_akreditasi')->label('Nilai')->suffix(' / 400')->placeholder('-')->alignCenter(),
