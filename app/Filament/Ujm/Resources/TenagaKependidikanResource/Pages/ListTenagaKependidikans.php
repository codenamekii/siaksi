...
class ListTenagaKependidikans extends ListRecords
{
  ...
  public function getTabs(): array
  {
    return [
      ...
      'pns' => Tab::make('PNS/PPPK')
        ->modifyQueryUsing(fn(Builder $query) => $query->whereIn('status_kepegawaian', ['PNS', 'PPPK'])),
      'non_asn' => Tab::make('Non-ASN')
        ->modifyQueryUsing(fn(Builder $query) => $query->whereIn('status_kepegawaian', ['Honorer', 'Kontrak', 'Tetap Non-ASN'])),
