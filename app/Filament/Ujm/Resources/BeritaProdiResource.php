...
class BeritaProdiResource extends Resource
{
        ...
        return $form->schema([
            ...
            Forms\Components\Section::make('Media')->schema([
                Forms\Components\FileUpload::make('gambar')
                    ->image()
                    ->directory('berita/prodi/' . (Auth::user()->program_studi_id ?? 'default'))
                    ->maxSize(2048)
            ...
            Forms\Components\Section::make('Status')
                ->schema([Forms\Components\Toggle::make('is_published')->label('Publish')->default(true), Forms\Components\Toggle::make('is_featured')->label('Featured')->default(false)->helperText('Tampilkan di halaman utama')])
                ->columns(2),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('tanggal_publikasi')->label('Tanggal')->dateTime('d M Y')->sortable(),
                ...
                Tables\Columns\TextColumn::make('creator.name')->label('Dibuat oleh')->toggleable(isToggledHiddenByDefault: true),
    ...
    {
        return static::getEloquentQuery()->where('is_published', false)->count() ?: null;
    }
